...
function initializeFilter() {
    ...
    const filterClase = document.getElementById('filter_clase');
    ...
    if (filterClase) {
        filterClase.addEventListener('change', applyFilters);
    }
...
function applyFilters() {
    ...
    const filterAlfabetico = document.getElementById('filter_alfabetico')?.value || '';
    const filterGenero = document.getElementById('filter_genero')?.value || '';
    const filterClase = document.getElementById('filter_clase')?.value || '';
    ...
    // Filter by class (subject) - This would need book-subject relationship
    // For now, we'll skip this filter as books don't have direct subject relationship
